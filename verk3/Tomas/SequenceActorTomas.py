...
class SequenceEnv:
    ...
    def learn_step(self, p, grad_ln_pi, value, advantage, h_tanh, reward):
        ...
        delta = reward + self.gamma * value - self.old_value[1].detach()
    ...
    def set_attributes(self):
        ...
        for i in range(2):
            ...
            one_hot_board = np.zeros((temp_board.size, 2 + 1))
